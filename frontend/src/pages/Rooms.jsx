        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-10">
          ...
          {rooms.map((room) => (
            <div
              ...
              className="bg-white/80 backdrop-blur-xl rounded-2xl p-8 shadow-md border border-white/40 cursor-pointer transition-all duration-300 hover:-translate-y-2 hover:shadow-2xl hover:shadow-amber-200/40"
            >
